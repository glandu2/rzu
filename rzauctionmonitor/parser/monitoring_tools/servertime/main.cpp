...
int main(int argc, char *argv[])
{
	...
	AutoAuthSession* authSession = new AutoAuthSession(gameSession, ip, port, account, password, serverIdx, recoDelay, autoReco, usersa ? ClientAuthSession::ACM_RSA_AES : ClientAuthSession::ACM_DES);
