...
function(add_exe_no_install name sources)
  if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/metadata.rc.in")
    ...
    string(REGEX REPLACE "-.*" "" VERSION_LIST ${CPACK_PACKAGE_VERSION})
    string(REPLACE "v" "" VERSION_LIST ${VERSION_LIST})
...
function(add_rztest name sources)
  ...
  add_test(NAME "${name}_test" COMMAND "${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/${name}_test" /configfile:./${name}_test.opt  /core.log.level:debug /core.log.consolelevel:info /core.log.dir=./log /trafficdump.dir=./traffic_log WORKING_DIRECTORY ${CMAKE_BINARY_DIR})
  set_tests_properties("${name}_test" PROPERTIES RUN_SERIAL TRUE)
endfunction()
